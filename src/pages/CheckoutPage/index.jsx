...
import { apiCreateOrderPaypal, apiOnApprovePaypal, apiUpdateStock } from '../../services/apiPaypal';
            ...
            try {
                await paypal.Buttons({
                    ...
                    async createOrder() {
                        ...
                        const idOrder = await apiCreateOrderPaypal(totalAmount);
                        return idOrder;
                    },
                    async onApprove(data) {
                        ...
                        // Actualizar stock
                        await apiUpdateStock(cartItems);
                            ...
                            <div className="row mb-5">
                                <div className="col-md-12">
                                    ...
                                    <div className="p-3 p-lg-5 border bg-white">
                                        <table className="table site-block-order-table mb-5">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td className="text-black">${cartItems.reduce((acc, item) => acc + item.qty * item.price, 0)}</td>
                                                </tr>
                                                <tr>
                                                    <td className="text-black font-weight-bold">
                                        ...
                                        <div className="form-group">
                                            <button className="btn btn-primary btn-lg py-3 btn-block" onClick={checkoutHandler}>
                                                Place Order
                                            </button>
                                        </div>
                                    </div>
